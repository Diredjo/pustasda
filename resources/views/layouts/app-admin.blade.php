...
<head>
    ...
    <title>@yield('title', 'Admin') — PUSTASDA</title>
...
<body>
    <div class="app-layout">
        @php $pageTitle = $pageTitle ?? 'Admin Panel'; @endphp
    ...
    <script>
        ...
        function toggleSub(el) {
            ...
            if (sub && sub.classList.contains('sidebar-sub')) sub.classList.toggle('open');
        }
        ...
        function showToast(title, msg, type = 'default') {
            ...
            t.innerHTML = `<i class="fa-solid ${icons[type] || 'fa-bell'} toast-icon"></i>
        ...
        <p style="font-size:.88rem;color:var(--gray);margin-bottom:20px;">
            Yakin ingin menghapus data ini? Tindakan ini <strong>tidak dapat dibatalkan</strong>.
        </p>
        <div style="display:flex;gap:8px;">
            <button class="btn btn-primary" style="background:var(--red);" onclick="document.getElementById('${formId}').submit()">
